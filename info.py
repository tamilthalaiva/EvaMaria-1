...
API_ID = int(environ.get('API_ID', '9146154'))
API_HASH = environ.get('API_HASH', '19127ae8d81cd1df061717d7eb1e704b')
BOT_TOKEN = environ.get('BOT_TOKEN', '5727074411:AAEV6oKqbRRpPPLAUK2aeCkHk-Pz-4661Pg')
